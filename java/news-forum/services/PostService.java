...
public class PostService {
  ...
  public static void savePost(Post post) {
    ...
    String SLQ_savePost = "INSER INTO " 
    + DatabaseInfo.Tables.POSTS + " VALUES (" 
    + 
     "\"" + post.getIdString() + "\", " +
     "\"" + post.getTitle() + "\", " +
     "\"" + post.getMessage() + "\", " +
    ...
    try (
      ...
      statement.executeUpdate(SLQ_savePost);
  ...
  public static List<Post> getPostsByUser(User user) {
    ...
    String SQL_postsByUser = "SELECT * FROM " 
    + 
     DatabaseInfo.Tables.POSTS +
     " WHERE USERS_ID = \"" + user.getIdString() + 
